...
<div class="container mt-5">
	<form action="<?php echo e(route('pqrsf2')); ?>" enctype="multipart/form-data" method="post">
		<div class="row">
			<div class="col-8">
				...
				<div class="col-3">
					<img src="<?php echo e(asset('assets/img/logo.png')); ?>" width="250" alt="">
			...
			<div class="form-group">
                ...
                <input type="hidden" name="radicado" value=<?php echo e(rand(000000,999999)); ?>>
				</div>
				<div class="form-group">
		...
		<div class="portfolio-modal modal fade" id="terminos" tabindex="-1" role="dialog" aria-hidden="true">
			...
			<?php echo $__env->make('thema.foot', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Raiesc/resources/views/pqrsf.blade.php ENDPATH**/ ?>