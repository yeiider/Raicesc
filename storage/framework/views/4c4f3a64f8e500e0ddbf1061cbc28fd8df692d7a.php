...
<?php echo $__env->make('thema.head2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


<nav class="navbar navbar-expand-lg navbar-dark fixed-top " id="mainNav" <?php if($datos['bg_nav']=='default'): ?>

style="background-color: #000000"
<?php else: ?>
style="background-color: <?php echo e($datos['bg_nav']); ?>"
<?php endif; ?>" >
<audio src="http://pontenlinea.com:8000/emisora" autoplay=""  id="audio"></audio>
<a class="navbar-brand js-scroll-trigger ml-5" href="#page-top" <?php if($datos['color']!='default'): ?> style="color: <?php echo e($datos['color']); ?>" <?php endif; ?>><?php echo e($datos['titulo']); ?></a>
...
<div class="collapse navbar-collapse" id="navbarResponsive">
  <ul class="navbar-nav text-uppercase ml-auto">
    ...
    <li class="nav-item">
      <a class="nav-link js-scroll-trigger" href="<?php echo e(route('pqrsf')); ?>">PQRSF</a>
    </li>
     <li class="nav-item">
    ...
    <?php if(isset(auth()->user()->email)): ?><li class="nav-item"><a href="<?php echo e(route('salir')); ?>" class="nav-link js-scroll-trigger">Salir</a></li><?php endif; ?>
  </ul>
</div>
</div>
</nav>
    ...
    <div class="bd-example">
      <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
          ...
          <?php $i=1; ?>
          <?php $__empty_1 = true; $__currentLoopData = $datos['banner']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="carousel-inner">
         ...
         <?php $__empty_1 = true; $__currentLoopData = $datos['banner']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
         <div class="carousel-item ">
          <img src="<?php echo e(asset("assets/img/banner/{$b->imagen}")); ?>" class="d-block w-100" alt="..." style="width: 1600px; height: 800px">
          <div class="carousel-caption d-none d-md-block">
           <div class="intro-heading text-uppercase" style="color: <?php if($b->descripcion!='default'): ?> <?php echo e($b->descripcion); ?> <?php else: ?> black <?php endif; ?>; font-size: 100px"><?php echo e($b->titulo); ?></div>
           <div class="intro-lead-in js-scroll-trigger" style="color: <?php if($b->descripcion!='default'): ?> <?php echo e($b->descripcion); ?>  <?php else: ?> black <?php endif; ?>; font-size: 75px"><?php echo e($b->subtitulo); ?></div>
           <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="<?php echo e($b->link); ?>">Conoce mas</a>
         </div>
       </div>
       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
       <?php endif; ?>
...
<style>
 ...
 .text-primary{
  color: <?php echo e($datos['primario']); ?> !important;
}
<?php else: ?> 
.text-primary{
...
<section class="bg-light page-section" id="portfolio">
  <div class="container">
    ...
    <?php if(isset(auth()->user()->email)): ?> <a href="javascript:finestraSecundaria('<?php echo e(route("add.portafolio")); ?>')" class="btn btn-primary service-heading mb-3"><i class="fas fa-plus "></i>Crear</a> <?php endif; ?>
    <div class="row">
      <?php $__empty_1 = true; $__currentLoopData = $datos['portafolio']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

      <div class="col-md-4 col-sm-6 portfolio-item">
        <a class="portfolio-link" data-toggle="modal" href="#<?php echo e($p->identificador); ?>">
          <div class="portfolio-hover">
            <div class="portfolio-hover-content">
              <i class="fas fa-plus fa-3x"></i>
            </div>
          </div>
          <img class="img-fluid" src="<?php echo e(asset("assets/img/portfolio/{$p->imagen}")); ?>" style="width: 400px; height: 300px">
        </a>
        <div class="portfolio-caption">
          <h4><?php echo e($p->titulo); ?></h4>
          <p class="text-muted"><?php echo e($p->subtitulo); ?></p>
          <?php if(isset(auth()->user()->email)): ?>  <a style=""  class="btn btn-primary" href="javascript:finestraSecundaria('<?php echo e(url("Portafolio/{$p->id}")); ?>')" ><i class="fa fa-edit"></i></a>
<a class="btn btn-primary" onclick="bootbox.confirm('Esta seguro que desea eliminar este Portafolio?. Tenga en cuenta que se perdera toda la informacion relacionada con <strong><?php echo e($p->titulo); ?></strong>', function(result) {
  if(result) {
    window.location.href = '<?php echo e(url("PortafolioDrop/{$p->id}")); ?>';
...
<section class="page-section" id="about">
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12">
       <?php if(isset(auth()->user()->email)): ?> <a href="javascript:finestraSecundaria('<?php echo e(route("historia")); ?>')" class="btn btn-primary service-heading mb-3"><i class="fas fa-plus "></i>Crear</a><?php endif; ?>

       <ul class="timeline">
        <?php $__empty_1 = true; $__currentLoopData = $datos['historia']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <li>
         <?php if(isset(auth()->user()->email)): ?>  <a style=""  class="btn btn-primary" href="javascript:finestraSecundaria('<?php echo e(url("Historia/update/{$h->id}")); ?>')" ><i class="fa fa-edit"></i></a>
<a class="btn btn-primary" onclick="bootbox.confirm('Esta seguro que desea eliminar este Historia?. Tenga en cuenta que se perdera toda la informacion relacionada con <strong><?php echo e($h->titulo); ?></strong>', function(result) {
  if(result) {
    window.location.href = '<?php echo e(url("Historia/drop/{$h->id}")); ?>';
  }}) "  style="opacity: 0,2; background: transparent;">
  <i class="fa fa-trash-alt"></i>
</a><?php endif; ?>
<div class="timeline-image">
  <img src="<?php echo e(asset("assets/img/about/{$h->imagen}")); ?>" class="rounded-circle img-fluid" alt="logo" width="200" height="200" >
...
<div class="timeline-panel">
  <div class="timeline-heading">
    ...
    <h4 class="subheading"><?php echo e($h->titulo); ?></h4>
  </div>
...
<ul class="radio">
 <?php if(isset(auth()->user()->email)): ?> <li><a class="btn -btn-primary portfolio-link"  data-toggle="modal" href="#config">
...
<section class="bg-light page-section" id="team">
  ...
  <?php $__empty_1 = true; $__currentLoopData = $datos['portafolio']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
  <div class="portfolio-modal modal fade" id="<?php echo e($p->identificador); ?>" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <h2 class="text-uppercase"><?php echo e($p->titulo2); ?></h2>
                <p class="item-intro text-muted"><?php echo e($p->subtitulo2); ?></p>
                <img class="img-fluid d-block mx-auto"  alt="" src="<?php echo e(asset("assets/img/portfolio/{$p->imagen2}")); ?>">
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <div class="row">
                  <div class="col-6">
                   <form action="<?php echo e(route('config')); ?>" autocomplete="off" class="mt-3" method="post">
                    <?php echo e(csrf_field()); ?>

                    <div class="form-group">
                     <label for="" class="label-control">Cambiar titulo de la pagina</label>
                     <input type="text" class="form-control" value="<?php echo e($datos['titulo']); ?>" name="titulo" id="titulo">
                   </div>
                   <div class="form-group">
                     <label for="color_titulo" class="control-label">Color del Titulo</label>
                     <input type="color" name="color_titulo" class="form-control" id="color_titulo" value="<?php echo e($datos['color']); ?>">
                   </div>

                   <div class="form-group">
                     <label for="color_nav" class="control-label">Color del fondo Nav</label>
                     <input type="color" name="bg_nav" class="form-control" id="color_nav" value="<?php echo e($datos['bg_nav']); ?>">
                   </div>
                   <div class="form-group">
                     <label for="primario" class="control-label">Color Primario</label>
                     <input type="color" name="primario" class="form-control" id="primario" value="<?php echo e($datos['primario']); ?>">
                   </div>
                   <div class="form-group">
              ...
              <div class="col-5">
                <form action="<?php echo e(route('create.banner')); ?>" method="post" autocomplete="off"  enctype="multipart/form-data">
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                <div class="row">
                  <div class="col-sm">
                    <a  class="portfolio-link" href="javascript:finestraSecundaria('<?php echo e(url("Banner/edit/{$b->id}")); ?>')"><img src="<?php echo e(asset("assets/img/banner/{$b->imagen}")); ?>" alt="" style="width: 100%"></a>
                  </div>
                  <div class="col-sm-12">
                    <h5><?php echo e($b->titulo); ?></h5>
                  </div>
                </div>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('thema.foot', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</html>
<?php /**PATH /var/www/html/Raicesc/resources/views/index.blade.php ENDPATH**/ ?>