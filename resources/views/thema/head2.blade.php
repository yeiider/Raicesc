...
<head>
  ...
  <link rel="stylesheet" href="{{asset('js/chosen.jquery.min')}}">
...
@else
.btn-primary {
  background-color:  {{$datos['primario']}} ;
  border-color: {{$datos['primario']}};
}

.btn-primary:active, .btn-primary:focus, .btn-primary:hover {
  background-color: {{$datos['primario']}} !important;
  border-color: {{$datos['primario']}} !important;
  color: white;
}
