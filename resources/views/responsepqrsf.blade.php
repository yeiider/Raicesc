...
<body>
  ...
  <div class=" mt-3 col-6">
     ...
     <div class="row">
      <div class="col-8">
        <h2>Nombre: <strong>{{$contenido['nombre']}}</strong></h2>
      </div>
    ...
    <div class="text">
      <p class="title">Tipo de Solicitud: <span class="conte">{{$contenido['motivo']}}</span></p>
    </div>
    <div class="text">
      <p class="title">Municiio: <span class="conte">{{$contenido['municipio']}}</span></p>
    </div>
    <div class="text">
    ...
    <div class="text">
      <div class="row">
       ...
       <div class="col-7">
        <p class="title">Extensión: <span class="conte">{{$contenido['extension']}}</span></p>
      </div>
    </div>
  </div>
    <div class="text">
